...
public class WarriorAttack : MonoBehaviour
{
    ...
    void Skill1v1()
    {
        ...
        anim.SetInteger("Attack", Random.Range(1, 11));                                             // Seleccionar un ataque.
    ...
    void Skill3()
    {
        anim.SetTrigger("AttackTrigger");                                                           // Activar la animación de ataque.
        anim.SetBool("IsAttacking", true);                                                          // Fijar la animación de ataque a verdadero.
        anim.SetInteger("Attack", 11);                                                              // Seleccionar un ataque.
    ...
    public void SkillBoost()
    {
        ...
        {
            playerStats.strength = 7;                                                               // Aumentar la fuerza.
    ...
    IEnumerator WaitSeconds()
    {
        ...
        playerStats.strength = 5;                                                                   // Reducir la fuerza.
