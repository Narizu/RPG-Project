...
public class BarbarianAttack : MonoBehaviour
{
    ...
    void Skill1v1()
    {
        ...
        anim.SetInteger("Attack", Random.Range(2, 7));                                              // Seleccionar un ataque.
    ...
    void Skill3()
    {
        anim.SetTrigger("AttackTrigger");                                                           // Activar la animación de ataque.
        anim.SetBool("IsAttacking", true);                                                          // Fijar la animación de ataque a verdadero.
        anim.SetInteger("Attack", 1);                                                               // Seleccionar un ataque.
    ...
    public void SkillBoost()
    {
        ...
        {
            playerStats.physique = 7;                                                               // Aumentar la constitución.
    ...
    IEnumerator WaitSeconds()
    {
        ...
        playerStats.physique = 5;                                                                   // Reducir la constitución.
